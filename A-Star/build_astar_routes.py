...
def generate_routes(net_file, trips_file, output_file, area_name):
    """Generate routes using A* with comprehensive logging"""
    ...
    for i, trip in enumerate(trips):
        ...
        if edges and path_metrics['success']:
            ...
            temp_route_file = f"temp_route_{i}.rou.xml"
...
if __name__ == "__main__":
    ...
    areas = [
        ("CP2", "CP2/cp2.net.xml", "A-Star/CP2/cp2_trips.xml", "A-Star/CP2/cp2_astar_routes.rou.xml"),
        ("ChandniChowk", "Chandni-Chowk/ch.net.xml", "A-Star/ChandniChowk/chandnichowk_trips.xml", "A-Star/ChandniChowk/chandnichowk_astar_routes.rou.xml"),
        ("RakabGanj", "Rakab-Ganj/rg.net.xml", "A-Star/RakabGanj/rakabganj_trips.xml", "A-Star/RakabGanj/rakabganj_astar_routes.rou.xml"),
        ("Safdarjung", "Safdarjung/SE.net.xml", "A-Star/Safdarjung/safdarjung_trips.xml", "A-Star/Safdarjung/safdarjung_astar_routes.rou.xml")
    ]
